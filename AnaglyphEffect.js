...
THREE.AnaglyphEffect = function ( renderer, width, height ) {
	...
	var _aspect, _near, _far, _fov, _focus;
	...
	this.render = function ( scene, camera ) {
		...
		var currentFocus = camera.focus !== undefined ? camera.focus : 125;
		var hasCameraChanged = ( _aspect !== camera.aspect ) || ( _near !== camera.near ) || ( _far !== camera.far ) || ( _fov !== camera.fov ) || ( _focus !== currentFocus );
		...
		if ( hasCameraChanged ) {
			...
			var eyeSep = _focus / 30 * 0.5;
			var eyeSepOnProjection = eyeSep * _near / _focus;
